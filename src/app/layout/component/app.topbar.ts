...
import { AppConfigurator } from '../../dashboard-admin/layout-admin/component/app.configurator';
import { LayoutService } from '../../dashboard-admin/layout-admin/service/layout.service';
...
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, AppConfigurator, ButtonModule,PopoverModule],
